...
// Declare constant container set equal to object document, 
//  method querySelector, passing as an argument class ".container"
const container = document.querySelector(".container");

// Declare constant playerTurn set equal to object document, 
//  method getElementById, passing as an argument id "playerTurn"
const playerTurn = document.getElementById("playerTurn");

// Declare constant message set equal to object document, 
//  method getElementById, passing as an argument id "message"
...
function setPiece(startCount, colValue){
    ...
    // Declare variable rows initialized to object document, 
    //  method querySelectorAll, passing argument class ".grid-row"
    ...
    // Else
        ...
        // Declare variable currentRow initialized to array rows, index startCount, method querySelectorAll, 
        //  passing as an argument class ".grid-box"
...
function fillBox(e){
    ...
    // Declare variable colValue set equal to function parseInt() 
    //  of parameter e, object target, function getAttribute, passing as argument "data-value"
